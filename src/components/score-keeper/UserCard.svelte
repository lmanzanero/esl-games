...
<div class="bg-white shadow-md border rounded px-8 pt-6 pb-8 mb-4 my-32">
  <label class="block text-grey-darker text-sm font-bold mb-2" for="username">
   ...
   <div>
    <input class="w-28 shadow appearance-none border rounded py-2 px-3 text-grey-darker leading-tight focus:outline-none focus:shadow-outline" id="score" type="text" placeholder={userData.score}>
