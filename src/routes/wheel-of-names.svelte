...
<svelte:head>
	...
	<meta
		name="description"
		content="A fun, free and easy to use spinner to make your class more engaging. Add names or words, and randomly the wheel to choose one!"
	/>
	<!-- Open Graph / Facebook -->
	<meta property="og:type" content="website" />
	<meta property="og:url" content="https://esl-games.vercel.app/wheel-of-names" />
	<meta property="og:title" content="Wheel of Names" />
	<meta
		property="og:description"
		content="A fun, free and easy to use spinner to make your class more engaging. Add names or words, and randomly the wheel to choose one!"
	/>
	<meta property="og:image" content="https://esl-games.vercel.app/wheel-of-names.png" />

	<!-- Twitter -->
	<meta property="twitter:card" content="summary_large_image" />
	<meta property="twitter:url" content="https://esl-games.vercel.app/wheel-of-names" />
	<meta property="twitter:title" content="Wheel of Names" />
	<meta
		property="twitter:description"
		content="A fun, free and easy to use spinner to make your class more engaging. Add names or words, and randomly the wheel to choose one!"
	/>
	<meta property="twitter:image" content="https://esl-games.vercel.app/wheel-of-names.png" />
</svelte:head>
<div class="container-fluid h-screen">
	<Toast {isShow} {toggleToast} />
	...
	<div class="flex justify-evenly flex-row flex-wrap m-auto">
		...
		<div id="wheelOfFortune" class="w-auto">
			<canvas bind:this={canvas} id="wheel" width="500" height="500" />
			<div id="spin">SPIN</div>
		</div>
		<div class="w-1/3 shadow">
			<button
				on:click={toggleModal}
				class="text-white bg-purple-700 hover:bg-purple-600 hover:text-gray-300 py-2 px-6 m-2 rounded-full flex"
			>
				<svg
			...
			<div class="flex flex-col mt-2 mb:mt-0 md:px-3">
				<button
					...
					class="button save rounded flex justify-center shadow w-full text-white bg-purple-700 hover:bg-purple-600 hover:text-gray-300 p-2 m-1"
				>
					<svg
						xmlns="http://www.w3.org/2000/svg"
				...
				<button
					class="button spinner rounded flex justify-center shadow w-full text-white bg-purple-700 hover:bg-purple-600 hover:text-gray-300 p-2 m-1"
				>
					<svg
						xmlns="http://www.w3.org/2000/svg"
						class="h-6 w-6"
	...
	<!-- Modal -->
	<div
		class={`fixed z-10 overflow-y-auto top-0 w-full left-0 ${!isModalOpen ? 'hidden' : ''}`}
		id="modal"
	>
		<div
		...
		>
			...
			>
				<div class="w-full flex overflow-x-scroll p-2">
					<button
						class="text-white w-28 bg-purple-700 hover:bg-purple-600 hover:text-gray-300 py-2 px-6 m-auto rounded-full flex"
					>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							class="h-5 w-5"
					...
					<button
						class="text-white w-28 bg-purple-700 hover:bg-purple-600 hover:text-gray-300 py-2 px-6 m-2 m-auto rounded-full flex"
					>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							class="h-5 w-5"
				...
				<div class="bg-gray-200 px-4 py-3 text-right">
					...
					<button
						...
						><i class="fas fa-plus" /> Update</button
					>
				</div>
			</div>
		</div>
