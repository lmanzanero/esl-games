<script>
	let correctSentences = [{ sentence: 'They are playing at the park' }];
	let list = [
		{ name: 'They', id: 0 },
		{ name: 'playing', id: 1 },
		{ name: 'at the park', id: 2 },
		{ name: 'are', id: 3 }
	];
	let hovering = false;
...
<svelte:head>
	...
	<meta
		name="description"
		content="A real time game to build and match sentences using darg and drop sorting."
	/>
</svelte:head>
...
<div class="text-center max-w-2xl mx-auto p-3">
	...
	<div class="flex justify-center">
		...
		<button
			on:click={() => (isListening = true)}
			class="bg-blue-500 text-white py-2 px-6 m-2 rounded-full {isListening ? 'animate-pulse' : ''}"
		>
			<svg
				xmlns="http://www.w3.org/2000/svg"
				class={isListening ? 'animate-ping h-4 w-4' : 'h-6 w-6'}
				fill="none"
				viewBox="0 0 24 24"
				stroke="currentColor"
			>
	...
	<div class="mt-4 flex justify-center">
		<img
			src="https://en.pimg.jp/060/269/387/1/60269387.jpg"
			alt="mockup"
			class="d-block rounded shadow-md"
		/>
	</div>
</div>
...
<div class="m-auto p-4">
	<h3 class="text-2xl md:text-2xl font-medium mb-2 m-auto text-center">Templates</h3>
	<div class="flex justify-center flex-row m-auto">
		<div class="card flex h-48 w-48 shadow m-2">
			<img
				width="100%"
				height="100%"
